...
def puede_gestionar_metas_tienda():
    """Quién puede poner/editar la meta y la venta del mes de cada asesor
    de ventas de su tienda — jefe de tienda y sub jefe de tienda (que son
    quienes dan seguimiento a su equipo), además de jefe_linea y admin.
    Mismo criterio de acceso que Minutas de Tienda."""
    u = current_user()
    return u is not None and u["rol"] in ("admin", "jefe_linea", "jefe_tienda", "subjefe_tienda")
